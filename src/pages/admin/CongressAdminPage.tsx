...
export function CongressAdminPage() {
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-white">Congress Admin</h1>
          <Badge variant="default" className="text-[10px]">Admin Only</Badge>
        </div>
        <p className="text-sm text-slate-400 mt-1">
          Administrative tools for managing congressional data
        </p>
      </div>
      ...
      <Card>
        <CardContent className="py-12 text-center space-y-4">
          ...
          <h2 className="text-lg font-semibold text-white">
            Congress Administration — Coming Soon
          </h2>
          <p className="text-sm text-slate-400 max-w-md mx-auto">
            Admin tools for managing election results, verifying candidate data,
            approving profile claims, moderating content, and managing user roles.
          </p>
          <Link
            to="/"
